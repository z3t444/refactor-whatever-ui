...
import { InstaIcon, GithubIcon, DiscordIcon, SearchIcon } from "@/components/icons";
export const Navbar = () => {
  const searchInput = (
    <Input
      aria-label="Search"
  ...
  return (
    <NextUINavbar className="max-w-5xl mx-auto border-t mt-5 px-4 border-neutral-600 rounded-full" maxWidth="xl" position="sticky">
